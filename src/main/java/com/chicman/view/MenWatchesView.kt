...
@SpringComponent
@UIScope
class MenWatchesView(private val eventHandler: ChicManUI) : VerticalLayout(),
    View {
    private val log =
        LoggerFactory.getLogger(MenWatchesView::class.java)
    ...
    private fun init() {
        ...
        val btnMenWatches =
            Button(Messages.get("page.men"))
        btnMenWatches.isEnabled = false
