...
//		groupBtn.addComponent(btnLogout);
    ...
    private void setupUserMenu() {
        ...
        loggedUser.addItem(Messages.get("auth.logout"), VaadinIcons.SIGN_OUT, logoutCmd);
...
//		btnLogout.addClickListener(e -> eventHandler.logout());
    ...
    public void setMenuAllWatchesActive() {
        clearActiveMenuStyle();
        setActiveMenuStyle(btnWatches);
    }

    public void setMenuWomenWatchesActive() {
        clearActiveMenuStyle();
        setActiveMenuStyle(btnWomen);
    }

    public void setMenuMenWatchesActive() {
        clearActiveMenuStyle();
	...
	public void clickWatchesWithDiscount() {
    	btnWatches.click();
