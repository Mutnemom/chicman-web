...
@SpringComponent
@UIScope
public class WatchesView extends VerticalLayout implements View {
    public static final String NAME = "watches";
    private final ChicManUI eventHandler;

    private final Logger log = LoggerFactory.getLogger(WatchesView.class);
    ...
    public WatchesView(ChicManUI eventHandler) {
    ...
    public void enter(ViewChangeListener.ViewChangeEvent event) {
        log.info("enter All Watches view with parameter /" + event.getParameters());
        eventHandler.getToolbar().setMenuAllWatchesActive();
    ...
    private void init() {
        ...
        Button btnWatches = new Button(Messages.get("page.watches.all"));
        btnWatches.setEnabled(false);
        ...
        // add page label
        Label pageLabel = new Label(Messages.get("page.watches.all"));
    ...
    public void sortItemByDiscount() {
