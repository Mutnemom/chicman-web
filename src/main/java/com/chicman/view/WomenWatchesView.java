...
@SpringComponent
@UIScope
public class WomenWatchesView extends VerticalLayout implements View {
    public static final String NAME = "watches-women";
    private final ChicManUI eventHandler;

    private final Logger log = LoggerFactory.getLogger(WomenWatchesView.class);
    ...
    public WomenWatchesView(ChicManUI eventHandler) {
    ...
    public void enter(ViewChangeListener.ViewChangeEvent event) {
        log.info("enter Women Watches view with parameter /" + event.getParameters());
        eventHandler.getToolbar().setMenuWomenWatchesActive();
    ...
    private void init() {
        ...
        Button btnWomenWatches = new Button(Messages.get("page.women"));
        btnWomenWatches.setEnabled(false);
        ...
        // add page label
        Label pageLabel = new Label(Messages.get("page.women"));
